...
import ModalDelete, { useModal } from "@/components/Modal";
...
export function FormRegistro({ registro }: FormRegistroProps) {
  ...
  return (
    <>
              ...
              <div className="flex flex-col w-36">
                ...
                <span className="input flex items-center">
                  ...
                  <input
                    ...
                    {...register("valor", {
                      onChange: (e) =>
                        (e.target.value = Formatter.maskcurrency(
                          e.target.value
                        )),
                    })}
      ...
      {registro && (
        <ModalDelete closeModal={closeModal} isOpen={isOpen}>
          <FormDelete onCancel={closeModal} registro={registro} />
        </ModalDelete>
      )}
    </>
  );
